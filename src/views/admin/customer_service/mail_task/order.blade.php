...
<div class="imain">
    <div class="itop ">
        <form method="get" action="/company_admin/customer_service/mail_task/order" class="select_form">
        ...
        <div class="">
            <a class="badge badge-info ajax_get show_all0_btn" data-href="/company_admin/customer_service/mail_task/import?id={{$res['info']->id}}">导入</a>
            <a class="badge badge-primary ajax_get show_all0_btn" data-href="/company_admin/customer_service/mail_task/send?id={{$res['info']->id}}">发送</a>
        </div>
    </div>
